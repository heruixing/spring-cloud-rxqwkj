package com.rxqwkj.auth.provider.config.auth;


import com.rxqwkj.auth.provider.config.auth.filter.PhoneLoginAuthenticationFilter;
import com.rxqwkj.auth.provider.config.auth.filter.QrLoginAuthenticationFilter;
import com.rxqwkj.auth.provider.config.auth.handler.MyLoginAuthSuccessHandler;
import com.rxqwkj.auth.provider.config.auth.provider.PhoneAuthenticationProvider;
import com.rxqwkj.auth.provider.config.auth.provider.QrAuthenticationProvider;
import com.rxqwkj.auth.provider.service.PhoneUserDetailService;
import com.rxqwkj.auth.provider.service.QrUserDetailService;
import com.rxqwkj.auth.provider.service.UsernameUserDetailService;
...
/**
 * Created by heruixing on 2018/4/15.
 */
@Configuration
